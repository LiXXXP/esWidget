...
<script>
    ...
    const dbMatchLive = ()=> import("@/components/game/csgo/matchLiveByDubai")  // csgo赛事 迪拜样式

    import { getMatchInfo } from "@/scripts/request.js"          // 请求方法
